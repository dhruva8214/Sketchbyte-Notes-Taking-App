...
[![Download APK](https://img.shields.io/badge/Download-Android%20APK-86efac?style=for-the-badge\&logo=android)](https://github.com/dhruva8214/Sketchbyte-Notes-Taking-App/releases)
...
| Multiple Boards | Unlimited canvas boards — create, name and switch in one click |
...
| Code to Diagram | Paste code and get an instant class diagram — 12+ languages |
...
| Store | Link | Status |
|---|---|---|
| GitHub Releases | [View Releases](https://github.com/dhruva8214/Sketchbyte-Notes-Taking-App/releases) | Auto-published on tag |
| Aptoide | [Developer Portal](https://www.aptoide.com/developer) | Upload APK manually |
| APKPure | [Developer Portal](https://developer.apkpure.com) | Upload APK manually |
...
**2. Add 4 GitHub Secrets** — go to repo > Settings > Secrets > Actions:
...
> **Important:** Never commit `*.keystore` or `keystore-base64.txt` to Git — they are already in `.gitignore`.
...
│   ├── DownloadPage.tsx     # Download and install guide
│   ├── CanvasApp.tsx        # Whiteboard app
│   ├── CodeToDiagramPage    # Code to Class Diagram tool
...
Built with love by **Dhruva M** — Think Without Limits.
